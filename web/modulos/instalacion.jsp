        ...
        <div class="col-sm-3">
            <form class="form small"  role="form">
                <div class="form-group">
                    <label for="select-plogistico">P. Log�stico</label>
                    <select disabled class="form-control-sm form-control small" id="select-plogistico">
                        <option selected value="1">Parque Log�stico Pudahuel</option>
                    </select>
                </div>
                <div class="form-group">
                    <label for="nom-instalacion" >Nombre Instalaci�n</label>
