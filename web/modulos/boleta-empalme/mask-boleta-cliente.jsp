<script src="modulos/boleta-empalme/mask-boleta-cliente.js?=<% out.print(modelo.Util.generaRandom(10000, 99999));%>" type="text/javascript"></script>
...
<script type="text/javascript">
    ...
    var desde = <%out.print(request.getParameter("desde"));%>;
    var hasta = <%out.print(request.getParameter("hasta"));%>;
    var DESDE = <%out.print(request.getParameter("desde"));%>;
    var HASTA = <%out.print(request.getParameter("hasta"));%>;
    var mes = HASTA.split("-")[0] + "-" + HASTA.split("-")[1];
    var MES = HASTA.split("-")[0] + "-" + HASTA.split("-")[1];
