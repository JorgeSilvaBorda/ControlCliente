...
<html>
    <head>
        ...
        <script src="modelo.js?=<% out.print(modelo.Util.generaRandom(10000, 99999)); %>" type="text/javascript"></script>
                                    ...
                                    if (idtipousuario != null) {
                                        if (Integer.parseInt(idtipousuario) == 2) {
                                            out.print("<li class='nav-item dropdown'>\n"
                                                    ...
                                                    + "<a onclick='cargarModulo(\"boleta-cliente\");' class='dropdown-item' href='#'>Emitir Detalle Complemento Servicios de Administración por Cliente</a> \n"
                                            ...
                                            out.print("<li class='nav-item dropdown'>\n"
                                                    ...
                                                    + "<a onclick='cargarModulo(\"hist-asignacion-remarcadores\");' class='dropdown-item' href='#'>Histórico de reasignación de remarcadores por cambio de cliente</a> \n"
                                                    + "</div>"
                                                    + "</li>");
                                            out.print("<li class='nav-item dropdown'>"
                                                    ...
                                                    + "<div class='dropdown-menu' aria-labelledby='navbarDropdownMenuLink'>\n"
                                                    + "<a class='dropdown-item' onclick='cargarModulo(\"control-comunicacion-nuevos\");' href='#'>Nuevos eventos Comunicación</a> \n"
                                                    + "<a class='dropdown-item' onclick='cargarModulo(\"control-comunicacion-todos\");' href='#'>Todos eventos Comunicación</a> \n"
                                                    + "<a class='dropdown-item' onclick='cargarModulo(\"control-comunicacion-excepciones\");' href='#'>Excepciones</a> \n"
